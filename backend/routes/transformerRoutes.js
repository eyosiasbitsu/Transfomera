...
const { getTechnicianTransformers, registerTransformer, getTransformerById, deleteTransformerById, updateTransformerById, getTransformers, addSensorData} = require('../controllers/transformerController');
